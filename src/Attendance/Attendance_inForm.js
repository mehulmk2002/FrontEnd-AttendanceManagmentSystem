...
const Attendance_inForm = ({LoginFlag,setLoginFlag}) => {
  ...
  firstInputRef.current.focus();
    ...
    return (
      <div style={{margin:'0 auto'}}>
        ...
        <div style={{display:'flex', margin:'15px 10px',justifyContent:'space-between'}}><div style={{textAlign:'center',fontWeight:'bold',borderBottom:'2px solid #000', fontSize:'28px'}}>Attendance Form</div>  <div  className="btn  btn-danger" onClick={onClickLogout}>Logout</div>
        </div><div>
